...
target_names = [
    ...
    "uEmu/3Dprinter", "uEmu/GPSTracker", "uEmu/LiteOS_IoT", "uEmu/Zepyhr_SocketCan", "uEmu/utasker_MODBUS", "uEmu/utasker_USB",
    "WYCINWYC/XML_Parser", "Pretender/RF_Door_Lock", "Pretender/Thermostat", "HALucinator/6LoWPAN_Receiver"
]
