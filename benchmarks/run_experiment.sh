...
# TARGET_LIST="P2IM/CNC P2IM/Console P2IM/Drone P2IM/Gateway P2IM/Heat_Press P2IM/PLC P2IM/Reflow_Oven  P2IM/Robot P2IM/Soldering_Iron P2IM/Steering_Control"
# TARGET_LIST="$TARGET_LIST uEmu/3Dprinter uEmu/GPSTracker uEmu/LiteOS_IoT uEmu/Zepyhr_SocketCan uEmu/utasker_MODBUS uEmu/utasker_USB"
# TARGET_LIST="$TARGET_LIST WYCINWYC/XML_Parser Pretender/RF_Door_Lock Pretender/Thermostat HALucinator/6LoWPAN_Receiver"
TARGET_LIST="P2IM/CNC P2IM/Console P2IM/Drone P2IM/Heat_Press P2IM/PLC P2IM/Reflow_Oven P2IM/Soldering_Iron P2IM/Steering_Control"
TARGET_LIST="$TARGET_LIST uEmu/3Dprinter uEmu/LiteOS_IoT uEmu/Zepyhr_SocketCan uEmu/utasker_MODBUS"
TARGET_LIST="$TARGET_LIST WYCINWYC/XML_Parser Pretender/RF_Door_Lock Pretender/Thermostat"
FUZZING_RUNTIME=24:00:00
#FUZZING_RUNTIME=00:00:10
