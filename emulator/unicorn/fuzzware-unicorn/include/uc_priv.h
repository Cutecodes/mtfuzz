...
typedef unsigned long (*uc_args_long_uc_t)(struct uc_struct*);
...
typedef void (*uc_args_uc_ptr_uint_uint_t)(struct uc_struct*, void *, uint32_t, uint32_t);
typedef void (*uc_args_uc_ptr_ptr_uint_uint_uint_t)(struct uc_struct*, void *, void *, uint32_t, uint32_t, uint32_t);
typedef void (*uc_args_uc_uint_uint_t)(struct uc_struct*, uint32_t, uint32_t);
typedef void (*uc_args_uc_int_t)(struct uc_struct*, int);
typedef void* (*uc_args_ptr_uc_t)(struct uc_struct*);
...
struct uc_struct {
    ...
    uc_args_uc_ptr_uint_uint_t fuzzer_init_cov;
    uc_args_uc_int_t fuzzer_reset_cov;
    uc_args_ptr_uc_t fuzzer_snapshot_cov;
    uc_args_uc_ptr_t fuzzer_restore_cov;
    uc_args_long_uc_t fuzzer_get_cov_prev_loc;
    uc_args_uc_long_t fuzzer_set_cov_prev_loc;

    uc_args_uc_ptr_ptr_uint_uint_uint_t fuzzer_init_cmplog;
    uc_args_uc_int_t fuzzer_reset_cmplog;
    uc_args_ptr_uc_t fuzzer_snapshot_cmplog;
    uc_args_uc_ptr_t fuzzer_restore_cmplog;
    uc_args_uc_uint_uint_t fuzzer_init_context;
    uc_args_uc_int_t fuzzer_reset_context;
    uc_args_ptr_uc_t fuzzer_snapshot_context;
    uc_args_uc_ptr_t fuzzer_restore_context;
