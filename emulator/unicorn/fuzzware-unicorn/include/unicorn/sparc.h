...
typedef enum uc_sparc_reg {
    ...
    UC_SPARC_REG_NPC,  // program next counter register
    UC_SPARC_REG_PSR,  // processor state register
    UC_SPARC_REG_WIM,  // processor state register
    UC_SPARC_REG_TBR,  // trap base register
    UC_SPARC_REG_FSR,  // FPU state register
