...
static inline void uc_common_init(struct uc_struct* uc)
{
    ...
    uc->fuzzer_snapshot_cov = fuzzer_snapshot_cov;
    uc->fuzzer_restore_cov = fuzzer_restore_cov;
    uc->fuzzer_get_cov_prev_loc = fuzzer_get_cov_prev_loc;
    uc->fuzzer_set_cov_prev_loc = fuzzer_set_cov_prev_loc;
    uc->fuzzer_init_cmplog = fuzzer_init_cmplog;
    uc->fuzzer_reset_cmplog = fuzzer_reset_cmplog;
    uc->fuzzer_snapshot_cmplog = fuzzer_snapshot_cmplog;
    uc->fuzzer_restore_cmplog = fuzzer_restore_cmplog;
    uc->fuzzer_init_context = fuzzer_init_context;
    uc->fuzzer_reset_context = fuzzer_reset_context;
    uc->fuzzer_snapshot_context = fuzzer_snapshot_context;
    uc->fuzzer_restore_context = fuzzer_restore_context;
