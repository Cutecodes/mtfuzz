...
void fuzzer_init_cmp_log(uc_engine *uc, void *headers, void* log,  uint32_t w, uint32_t h, uint32_t cnt, uint32_t shadow_hash);
int fuzzer_get_cmp_cnt(uc_engine *uc);
int fuzzer_get_cmp_hash(uc_engine *uc);
